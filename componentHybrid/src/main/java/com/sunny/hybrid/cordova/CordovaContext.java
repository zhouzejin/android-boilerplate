...
public class CordovaContext implements CordovaInterface {
    private static final String TAG = "CordovaContext";
    protected Activity activity;
    protected ExecutorService threadPool;
    protected PluginManager pluginManager;

    protected CordovaContext.ActivityResultHolder savedResult;
    ...
    public CordovaContext(Activity activity, ExecutorService threadPool) {
    ...
    public boolean onActivityResult(int requestCode, int resultCode, Intent intent) {
        ...
        if (callback == null && initCallbackService != null) {
            ...
            savedResult = new CordovaContext.ActivityResultHolder(requestCode, resultCode, intent);
            if (pluginManager != null) {
