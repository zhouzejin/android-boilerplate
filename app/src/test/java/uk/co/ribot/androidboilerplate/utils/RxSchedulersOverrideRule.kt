...
class RxSchedulersOverrideRule : TestRule {
    ...
    private val mRxAndroidSchedulersHook = Function<Callable<Scheduler>, Scheduler> { getScheduler() }

    private val mRxJavaImmediateScheduler = Function<Scheduler, Scheduler> { getScheduler() }
