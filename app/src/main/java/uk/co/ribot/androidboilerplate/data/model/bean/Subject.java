...
public abstract class Subject implements SubjectModel, Parcelable, Comparable<Subject> {
    ...
    public static final Factory<Subject> FACTORY = new Factory<>(
            ...
            MyColumnAdapterFactory.INSTANCE.getRATING_ADAPTER(),
            MyColumnAdapterFactory.INSTANCE.getGENRES_ADAPTER(),
            MyColumnAdapterFactory.INSTANCE.getPERSONS_ADAPTER(),
            MyColumnAdapterFactory.INSTANCE.getPERSONS_ADAPTER(),
            MyColumnAdapterFactory.INSTANCE.getIMAGE_ADAPTER());
